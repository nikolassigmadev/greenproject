...
const IRA_COCOA_LAWSUIT: FlagSource = {
  url: 'https://www.courtlistener.com/docket/59248551/coubaly-v-cargill-incorporated/',
  title: 'Coubaly et al. v. Cargill Inc., Nestlé USA, Barry Callebaut USA, Mars Inc., Hershey Co., Mondelēz Global LLC (D.D.C. 1:21-cv-00386)',
  publisher: 'U.S. District Court, District of Columbia (via CourtListener)',
  type: 'court_filing',
  tier: 'tier1',
...
const HRW_ECUADOR_2002: FlagSource = {
  url: 'https://www.hrw.org/report/2002/04/25/tainted-harvest/child-labor-and-obstacles-organizing-ecuadors-banana-plantations',
...
export const brandFlagsV2: BrandFlagV2[] = [
  ...
  // ── FERRERO ─────────────────────────────────────────────────────────────
  {
    ...
    sources: [
      DOL_TVPRA_COCOA,
      {
        url: 'https://www.bbc.com/news/stories-49741675',
        title: 'Is Nutella made with nuts picked by children? (Turkey hazelnut harvest)',
        publisher: 'BBC',
        type: 'investigative_journalism',
        tier: 'tier3',
      ...
      {
        url: 'https://www.business-humanrights.org/en/latest-news/turkey-investigation-links-ferrero-to-exploitation-of-hazelnut-pickers-child-labour-low-pay-long-hours-includes-comments-from-ferrero/',
        title: 'Turkey: Investigation links Ferrero to exploitation of hazelnut pickers, child labour, low pay & long hours',
        publisher: 'Business & Human Rights Resource Centre',
        type: 'ngo_report',
        tier: 'tier2',
        publishedDate: '2019-09-19',
  ...
  // ── LINDT ───────────────────────────────────────────────────────────────
  {
    ...
    sources: [
      ...
      {
        url: 'https://www.srf.ch/news/schweiz/lindt-spruengli-in-schweizer-schoggi-steckt-kinderarbeit',
  ...
  // ── COCA-COLA ────────────────────────────────────────────────────────────
  {
    ...
    sources: [
      DOL_TVPRA_SUGAR,
      {
        url: 'https://www.hrw.org/report/2004/06/09/turning-blind-eye/hazardous-child-labor-el-salvadors-sugarcane-cultivation',
  ...
  // ── PEPSICO ──────────────────────────────────────────────────────────────
  {
    ...
    sources: [
      ...
      {
        url: 'https://www.ran.org/sf20scorecard/',
  ...
  // ── UNILEVER ─────────────────────────────────────────────────────────────
  {
    ...
    sources: [
      AMNESTY_PALM_OIL,
      {
        url: 'https://www.ap.org/explore/seafood-from-slaves/',
  ...
  // ── TETLEY ───────────────────────────────────────────────────────────────
  {
    ...
    sources: [
      ...
      {
        url: 'https://www.cao-ombudsman.org/cases/india-tata-tea-02assam',
        title: 'India: Tata Tea-02/Assam — CAO complaint on labour conditions at APPL tea plantations',
        publisher: 'Office of the Compliance Advisor/Ombudsman (World Bank Group)',
        type: 'regulatory_finding',
        tier: 'tier2',
  ...
  // ── LAVAZZA ──────────────────────────────────────────────────────────────
  {
    ...
    sources: [
      DOL_TVPRA_COFFEE,
      {
        url: 'https://reporterbrasil.org.br/2022/05/multinational-coffee-companies-ignore-accusations-and-continue-buying-from-suppliers-linked-to-farms-with-slave-labour/',
        title: 'Multinational coffee companies ignore accusations and continue buying from suppliers linked to farms with slave labour',
  ...
  // ── FANJUL / ASR GROUP ───────────────────────────────────────────────────
  {
    ...
    sources: [
      ...
      {
        url: 'https://www.npr.org/2022/11/29/1139765236/u-s-bans-dominican-sugar-company-over-forced-labor',
        title: 'U.S. bans Dominican sugar company over forced labor',
        publisher: 'NPR',
        type: 'news_report',
        tier: 'tier3',
      ...
      {
        url: 'https://corpaccountabilitylab.org/calblog/2023/11/23/one-year-since-central-romana-sugar-banned-from-us-market-for-forced-labor',
        title: 'One year since Central Romana sugar banned from US market for forced labor',
  ...
  // ── CHICKEN OF THE SEA ───────────────────────────────────────────────────
  {
    ...
    sources: [
      ...
      {
        url: 'https://www.greenpeace.org/static/planet4-aotearoa-stateless/2018/05/turnthetide.pdf',
        title: 'Turn The Tide — human rights abuses and illegal fishing in Thailand\'s overseas fishing industry',
  ...
  // ── BUMBLE BEE ───────────────────────────────────────────────────────────
  {
    ...
    sources: [
      {
        url: 'https://www.business-humanrights.org/en/latest-news/usa-forced-labour-case-filed-against-bumble-bee-foods-by-indonesian-fishers-alleging-egregious-abuse-on-board-vessels-in-co-supply-chain-incl-co-comment/',
        title: 'Akhmad v. Bumble Bee Foods LLC, No. 3:25-cv-00583 (S.D. Cal.) — forced labour in tuna supply fleet',
        publisher: 'Business & Human Rights Resource Centre',
        type: 'court_filing',
        tier: 'tier2',
      ...
      {
        url: 'https://www.greenpeace.org/usa/gpea-report-fake-my-catch/',
        title: 'Fake My Catch — the unreliable traceability in our tuna cans (Bumble Bee supply chain)',
        publisher: 'Greenpeace',
        type: 'ngo_report',
        tier: 'tier2',
      ...
      {
        url: 'https://corpaccountabilitylab.org/calblog/2022/4/1/major-tuna-company-sued-for-claiming-sustainability-while-likely-relying-on-forced-labor',
        title: 'Major tuna company sued for claiming sustainability while likely relying on forced labor',
        publisher: 'Corporate Accountability Lab',
        type: 'ngo_report',
        tier: 'tier2',
        publishedDate: '2022-01-01',
  ...
  // ── TYSON ────────────────────────────────────────────────────────────────
  {
    ...
    sources: [
      DOL_SANITATION_2022,
      {
        url: 'https://www.nytimes.com/2023/09/23/us/politics/child-labor-tyson-perdue.html',
        title: 'Tyson and Perdue are under federal investigation over child labor',
      ...
      {
        url: 'https://investigatemidwest.org/2022/11/15/5-things-to-know-about-the-new-dol-complaint-about-child-labor-in-meatpacking-plants/',
        title: '5 things to know about the DOL complaint about child labor in meatpacking plants',
  ...
  // ── JBS ──────────────────────────────────────────────────────────────────
  {
    ...
    sources: [
      DOL_SANITATION_2022,
      {
        url: 'https://www.cohenmilstein.com/tyson-jbs-to-pay-127-million-to-resolve-workers-wage-fixing-lawsuit/',
        title: 'Tyson, JBS to pay $127M to resolve workers\' wage-fixing lawsuit (D. Colo.)',
        publisher: 'Cohen Milstein (class co-lead counsel)',
        type: 'court_filing',
        tier: 'tier2',
