...
export function Header() {
  ...
  return (
    <header
      className={cn(
        "sticky top-0 z-50 w-full border-b border-border/50 bg-background/80 backdrop-blur-lg transition-all duration-300",
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                className={cn(
                  "flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-all duration-200 group",
                  isActive
