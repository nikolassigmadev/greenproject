      ...
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center px-4">
          <div className="text-center max-w-sm">
            ...
            <h1 className="text-2xl font-black text-green-950 mb-3">Product Not Found</h1>
            <p className="text-gray-500 mb-8">The product you're looking for doesn't exist.</p>
            <Link to="/products" className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl bg-green-900 text-white font-bold">
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="relative bg-green-900">
        <div className="relative h-72 sm:h-96 overflow-hidden">
          {product.imageUrl ? (
            ...
            <div className="w-full h-full flex items-center justify-center text-8xl bg-green-950">
      ...
      <main className="flex-1">
        {/* White results card */}
        <div className="bg-background -mt-4 rounded-t-3xl relative z-10">
          <div className="max-w-screen-md mx-auto px-5 sm:px-6 pt-6 pb-8">
            {/* Category chip + product header */}
            <div className="flex items-start justify-between gap-3 mb-5">
              <div className="flex-1">
                <span className="inline-flex mb-3 px-3 py-1 rounded-full bg-green-900 text-white text-xs font-bold">{product.category}</span>
                <h1 className="text-2xl sm:text-3xl font-black text-green-950 leading-tight">{product.name}</h1>
            ...
            {/* Score breakdown */}
            <div className="bg-green-50/60 rounded-2xl p-4 mb-4">
              <p className="text-sm font-bold text-green-950 mb-3">Score Breakdown</p>
            ...
            {product.materials.length > 0 && (
              <div className="bg-green-50/60 rounded-2xl p-4 mb-4">
                <div className="flex items-center gap-2 mb-3"><Package className="w-4 h-4 text-gray-500" /><p className="text-sm font-bold text-green-950">Contents / Materials</p></div>
            ...
            {/* Transport */}
            <div className="bg-green-50/60 rounded-2xl p-4 mb-4">
              <div className="flex items-center gap-2 mb-2"><Truck className="w-4 h-4 text-gray-500" /><p className="text-sm font-bold text-green-950">Transport Distance</p></div>
              <p className="text-2xl font-black text-green-950">{product.transportDistance.toLocaleString()} <span className="text-sm font-semibold text-gray-500">km</span></p>
            </div>

            {/* Comments */}
            {product.comments && (
              <div className="bg-green-50/60 rounded-2xl p-4 mb-4">
                <p className="text-sm font-bold text-green-950 mb-2">Product Information</p>
            ...
            {/* OpenFoodFacts data */}
            {offQuery.isLoading && (
              <div className="bg-green-50/60 rounded-2xl p-4 mb-4 flex items-center gap-3">
                ...
                {!showEnvDetail ? (
                  <div className="space-y-3">
                    ...
                    <button
                      ...
                      className="w-full py-3.5 rounded-2xl border-2 border-green-200 text-green-900 font-bold text-sm flex items-center justify-center gap-2 hover:bg-green-50 transition-colors"
                    >
                  ...
                  <div>
                    <button onClick={() => setShowEnvDetail(false)} className="mb-3 text-sm font-semibold text-gray-500 flex items-center gap-1.5 hover:text-green-900 transition-colors">
            ...
            <div className="space-y-3 pt-2">
              ...
              <Link
                to="/products"
                className="w-full py-4 rounded-2xl bg-green-900 text-white font-bold text-base flex items-center justify-center"
              >
                Done
              </Link>
            </div>
          ...
          <section className="py-12 bg-gray-50">
            <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
              <div className="flex items-end justify-between mb-8">
                <div>
                  <h2 className="text-2xl font-black text-green-950 tracking-tight">Better Alternatives</h2>
